...
class TestStravaWebhookView:
    ...
    @pytest.mark.asyncio
    async def test_webhook_view_post_success(self, hass, mock_webhook_data, mock_coordinator):
    ...
    async def test_webhook_view_post_invalid_json(self, hass: HomeAssistant):
        ...
        request = MagicMock()
        import json
        request.json = AsyncMock(side_effect=json.JSONDecodeError("Invalid JSON", "doc", 0))
        request.headers.get.return_value = "example.com"
...
class TestWebhookSubscription:
    ...
    @pytest.mark.asyncio
    async def test_renew_webhook_subscription_success(self, hass, mock_config_entry, aioresponses_mock):
        ...
        # Mock get_url
        with patch("custom_components.ha_strava.get_url", return_value="https://example.com"):
            # Mock existing subscriptions
            aioresponses_mock.get(
                "https://www.strava.com/api/v3/push_subscriptions?client_id=test_client_id&client_secret=test_client_secret",
                payload=[],
                status=200
            )
    ...
    @pytest.mark.asyncio
    async def test_renew_webhook_subscription_no_public_url(self, hass, mock_config_entry):
        """Test webhook subscription without public URL."""
        async for hass_instance in hass:
            hass = hass_instance
            break
        # Mock get_url to raise NoURLAvailableError
        with patch("custom_components.ha_strava.get_url", side_effect=NoURLAvailableError):
            # Test webhook subscription
            await renew_webhook_subscription(hass, mock_config_entry)
    ...
    @pytest.mark.asyncio
    async def test_renew_webhook_subscription_existing_subscription(self, hass, mock_config_entry, aioresponses_mock):
        ...
        with patch("custom_components.ha_strava.get_url", return_value="https://example.com"):
            ...
            aioresponses_mock.get(
                "https://www.strava.com/api/v3/push_subscriptions",
                payload=[{"id": 1, "callback_url": "https://example.com/api/strava/webhook"}],
                status=200
            )
    ...
    @pytest.mark.asyncio
    async def test_renew_webhook_subscription_cleanup_old(self, hass, mock_config_entry, aioresponses_mock):
        ...
        with patch("custom_components.ha_strava.get_url", return_value="https://example.com"):
            ...
            aioresponses_mock.get(
                "https://www.strava.com/api/v3/push_subscriptions",
                payload=[{"id": 1, "callback_url": "https://old.example.com/api/strava/webhook"}],
                status=200
            )
    ...
    @pytest.mark.asyncio
    async def test_renew_webhook_subscription_error(self, hass, mock_config_entry, aioresponses_mock):
...
class TestAsyncSetupEntry:
    ...
    @pytest.mark.asyncio
    async def test_async_setup_entry_success(self, hass, mock_config_entry, mock_coordinator):
        """Test successful async setup entry."""
        async for hass_instance in hass:
            hass = hass_instance
            break
        with patch("custom_components.ha_strava.StravaDataUpdateCoordinator", return_value=mock_coordinator):
            with patch("custom_components.ha_strava.renew_webhook_subscription", new_callable=AsyncMock):
    ...
    async def test_async_setup_entry_error(self, hass, mock_config_entry):
        ...
        async for hass_instance in hass:
            hass = hass_instance
            break
        with patch("custom_components.ha_strava.StravaDataUpdateCoordinator", side_effect=Exception("Test error")):
...
class TestAsyncUnloadEntry:
    ...
    @pytest.mark.asyncio
    async def test_async_unload_entry_success(self, hass, mock_config_entry, aioresponses_mock):
    ...
    @pytest.mark.asyncio
    async def test_async_unload_entry_webhook_deletion_error(self, hass, mock_config_entry, aioresponses_mock):
    ...
    @pytest.mark.asyncio
    async def test_async_unload_entry_platform_unload_failure(self, hass, mock_config_entry):
