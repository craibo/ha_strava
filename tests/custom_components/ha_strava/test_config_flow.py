...
from custom_components.ha_strava.config_flow import OAuth2FlowHandler, OptionsFlowHandler
...
class TestStravaConfigFlow:
    ...
    async def test_user_step_success(self, hass: HomeAssistant):
        ...
        with patch("custom_components.ha_strava.config_flow.get_url") as mock_get_url, \
             patch("custom_components.ha_strava.config_flow.config_entry_oauth2_flow.async_register_implementation") as mock_register:
    ...
    async def test_options_step_success(self, hass: HomeAssistant, mock_config_entry):
        ...
        assert result["data"][CONF_ACTIVITY_TYPES_TO_TRACK] == ["Run", "Ride", "Hike", "Swim"]

    @pytest.mark.asyncio
    async def test_options_step_validation_error(self, hass: HomeAssistant, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_options_step_invalid_activity_types(self, hass: HomeAssistant, mock_config_entry):
        ...
        assert result["type"] == FlowResultType.CREATE_ENTRY
        assert result["data"][CONF_ACTIVITY_TYPES_TO_TRACK] == ["InvalidType1", "InvalidType2"]

    @pytest.mark.asyncio
    async def test_options_step_mixed_valid_invalid_types(self, hass: HomeAssistant, mock_config_entry):
        ...
        assert result["type"] == FlowResultType.CREATE_ENTRY
        assert result["data"][CONF_ACTIVITY_TYPES_TO_TRACK] == ["Run", "InvalidType", "Ride"]

    @pytest.mark.asyncio
    async def test_options_step_all_activity_types(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_options_step_default_activity_types(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_options_step_case_sensitivity(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_options_step_duplicate_activity_types(self, hass: HomeAssistant, mock_config_entry):
        ...
        assert result["data"][CONF_ACTIVITY_TYPES_TO_TRACK] == ["Run", "Ride", "Run", "Walk"]

    @pytest.mark.asyncio


    async def test_options_step_whitespace_activity_types(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_options_step_none_activity_types(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_options_step_missing_activity_types(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_options_step_non_list_activity_types(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_options_step_very_long_activity_types_list(self, hass: HomeAssistant, mock_config_entry):
        ...
        flow = OptionsFlowHandler(mock_config_entry)
        flow.hass = hass
        flow.options = {}  # Test options step with very long list (more than supported types)
        long_list = SUPPORTED_ACTIVITY_TYPES + ["InvalidType1", "InvalidType2"]
        result = await flow.async_step_init({
            CONF_ACTIVITY_TYPES_TO_TRACK: ["Run", "Ride", "Hike", "Swim"],
            CONF_PHOTOS: True,
            CONF_IMG_UPDATE_INTERVAL_SECONDS: 15,
    ...
    async def test_options_step_activity_types_with_special_characters(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_options_step_activity_types_with_numbers(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_options_step_activity_types_with_unicode(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_options_step_activity_types_with_whitespace_only(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_options_step_activity_types_with_empty_strings(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_options_step_activity_types_with_none_values(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_options_step_activity_types_with_mixed_types(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_options_step_activity_types_with_dict_values(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_options_step_activity_types_with_list_values(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_options_step_activity_types_with_boolean_values(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_options_step_activity_types_with_float_values(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_options_step_activity_types_with_complex_values(self, hass: HomeAssistant, mock_config_entry):
        ...
        result = await flow.async_step_init({
            CONF_ACTIVITY_TYPES_TO_TRACK: ["Run", {"nested": {"key": "value"}}, "Ride"],
            CONF_PHOTOS: True,
            CONF_IMG_UPDATE_INTERVAL_SECONDS: 15,
            CONF_DISTANCE_UNIT_OVERRIDE: "default",
        })
