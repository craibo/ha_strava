...
class TestFormatSecondsToHumanReadable:
    ...
    def test_minutes_and_seconds(self):
        ...
        assert format_seconds_to_human_readable(60) == "1min"
    ...
    def test_float_values(self):
        ...
        assert format_seconds_to_human_readable(60.7) == "1min"
    ...
    def test_omits_zero_values(self):
        ...
        assert format_seconds_to_human_readable(3605) == "1h 5sec"
        # 1 day 5 minutes (no hours or seconds)
        assert format_seconds_to_human_readable(86700) == "1d 5min"
    ...
    def test_comprehensive_examples(self):
        ...
        assert format_seconds_to_human_readable(1800) == "30min"  # 30-minute workout
